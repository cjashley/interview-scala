...
object HttpVerySimple {
  ...
  def get(url: String, connectTimeout: Int = 5000, readTimeout: Int = 5000, requestMethod: String = "GET",reqProp: Seq[(String, String)] = Seq.empty): String = {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val content = get("http://localhost:8080/rates?pair=NZDUSD",reqProp = reqProp)
    println(content)
